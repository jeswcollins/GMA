...
If a group wants to get away with not having group meetings while their advisor is on sabbatical, it may be best not to automatically send the advisor a group meeting cancellation e-mail every week. This feature could be implemented with a "sabbatical" boolean. But it'd probably be best to continue the autoSignUp process to give the advisor the sabbatical they deserve without making them worry about group meeting continuity in their absence :)
